...
import IconTresure from 'assets/images/icons/icon-treasure.svg';
...
//  di pindahkan ke file utils/formatNumber}
					...
					<div className="row" style={{ marginTop: '80px' }}>
						<div className="col-auto" style={{ marginRight: 35 }}>
							...
							<h6 className="mt-3">
								...
								<span className="text-gray500 font-weight-light">travelers</span>
							</h6>
						</div>
						<div className="col-auto" style={{ marginRight: 35 }}>
							<img width="36" height="36" src={IconTresure} alt={`${props.data.treasures} Treasures`} />
							<h6 className="mt-3">
								{formatNumber(props.data.treasures)}{' '}
								<span className="text-gray500 font-weight-light">treasures</span>
							</h6>
						</div>
						<div className="col-auto">
							...
							<h6 className="mt-3">
								...
								<span className="text-gray500 font-weight-light">cities</span>
							</h6>
						</div>
					</div>
				</div>
